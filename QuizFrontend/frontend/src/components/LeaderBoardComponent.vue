<template>
 <body>
    <main>
      <div id="header">
        <h1>{{ leaderBoard.leaderBoardName }}</h1>
        <button class="share">
      ...
      <div id="leaderboard">
        ...
        <table>
            <th>
                <tr>
                    <td class="number">Rank</td>
                     <td class="name" style="text-transform: capitalize;">Name</td>
                     <td >Accuracy</td>      
                     <td class="points"></td>
                </tr>
            </th>
           <tr v-for="(scoreCard,index) in scoreCards" :key="scoreCard.id">
            ...
            <td class="points">
              {{ scoreCard.score }}<img class="gold-medal" src="https://github.com/malunaridev/Challenges-iCodeThis/blob/master/4-leaderboard/assets/gold-medal.png?raw=true" alt="gold medal"/>
            </td>
          </tr>
